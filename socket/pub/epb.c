...
__inline static int sizeof_tag(uint16_t tag)
{
...
__inline static int epb_pack_buf_remain(Epb *e)
{
...
/**************epb_set_fixed32,epb_set_sfixed32, epb_set_float ********************/
