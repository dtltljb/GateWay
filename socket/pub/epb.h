...
//================================= DeviceRegister ==============
#define TAG_Varint_Type							0 //int32, int64, uint32, uint64, sint32, sint64, bool, enum
#define TAG_64_bit_Type							1	//fixed64, sfixed64, double
#define TAG_Length_delimit_Type			2 //string, bytes, embedded messages, packed repeated fields							
#define TAG_Start_group_Type				3 //groups (deprecated)
#define TAG_End_group_Type					4 //groups (deprecated)
#define TAG_32_bit_Type							5 //fixed32, sfixed32, float
//============================================================
